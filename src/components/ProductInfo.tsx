...
export default function ProductInfo() {
  ...
  const originalPrice = products.original || products.price
  ...
  return (
    <section className="space-y-4 py-4 px-6">
        ...
        <div className="flex flex-col gap-4 md:flex-row">
            ...
            <button className="flex items-center justify-center gap-2 p-4 bg-orange-400 text-black font-bold rounded-md shadow-card hover:opacity-90 active:scale-[0.99]" 
            onClick={() => addItem({ id: products.id, title: products.title, price: discountedPrice, quantity: value, thumbnail: products.thumbnails[0] })}>
