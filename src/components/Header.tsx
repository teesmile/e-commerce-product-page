...
export default function Header() {
  ...
  <nav className=" mx-auto container flex items-center justify-between px-8 gap-2 h-14 md:pt-10 md:px-6">
      ...
      <hr className="hidden lg:block lg:mx-30 md:mx-5 md:mt-15 md:border-gray-200" />
    </header>
  );
}
